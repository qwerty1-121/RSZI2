...
BoolEquation::BoolEquation(
    ...
    int count,
    BBV mask,
    IVariableSelector *variableSelector)
    : variableSelector_(variableSelector)
{
...
BoolEquation::BoolEquation(BoolEquation &equation)
    : variableSelector_(equation.variableSelector_)
{
...
void BoolEquation::setVariableSelector(IVariableSelector *variableSelector)
{
    variableSelector_ = variableSelector;
}
...
{
    static MinUndefinedSelector defaultSelector;

    if (variableSelector_ == nullptr) {
        return defaultSelector.selectVariable(*this);
    }

    return variableSelector_->selectVariable(*this);
}